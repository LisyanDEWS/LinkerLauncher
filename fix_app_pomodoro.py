...
# I will replace from WIDGET 3 to WIDGET 4 with just WIDGET 3 LinkerGAMES and WIDGET 4
fix_html = """        {/* WIDGET 3: LinkerGAMES */}
        ...
        {/* WIDGET 4: App Launcher */}"""

content = re.sub(r'        \{\/\* WIDGET 3: LinkerGAMES \*\/\}.*?\{\/\* WIDGET 4: App Launcher \*\/\}', fix_html, content, flags=re.DOTALL)
