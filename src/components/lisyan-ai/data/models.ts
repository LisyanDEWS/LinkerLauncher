...
export const MODELS: ModelInfo[] = [
  {
    id: "lnv1",
    name: "LNv1 Fast",
    tagline: "Fast & intelligent responses",
    description: "⚡ Быстрый и надежный ассистент: мгновенные ответы, рассуждения, код и анализ документов без задержек.",
  ...
  },
  {
    ...
    description: "Мощная 70B+ модель для сложного анализа, длинных текстов, кода и форматированных таблиц с мульти-провайдерным отказоустойчивым шлюзом.",
