...
start_marker = '<main className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-'
end_marker = '{/* PANEL: Link list with real working COPY buttons */}'
...
if start_idx != -1 and end_idx != -1:
    ...
    new_grids = r'''<main className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" id="row1-bento-grid">
    ...
    content = before + new_grids + after
