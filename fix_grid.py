...
# We need to find the <main ... id="row1-bento-grid"> ... </main> block.
# Since it's large and might have nested <main> or </main>, we can just use regex.
pattern = re.compile(r'(<main className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-\d gap-4" id="row1-bento-grid">)(.*?)(</main>)', re.DOTALL)

new_main = r'''<main className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4" id="row1-bento-grid">
...
content = re.sub(pattern, new_main, content)
